...
namespace Knit.Framework.Editor
{
	sealed class MenuOptions
	{
		...
		static public void AddScrollRect( MenuCommand menuCommand)
		{
			...
			scrollRect.HorizontalScrollbar = CreateScrollbar( "ScrollbarHorizontal", Scrollbar.Direction.LeftToRight, menuCommand, scrollRectObject);
			scrollRect.VerticalScrollbar = CreateScrollbar( "ScrollbarVertical", Scrollbar.Direction.BottomToTop, menuCommand, scrollRectObject);
		}
		static Scrollbar CreateScrollbar( string objectName, Scrollbar.Direction duration, MenuCommand menuCommand, GameObject parentObject)
		{
